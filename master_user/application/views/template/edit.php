            ...
            <div class="card card-4">
                <div class="card-body">
                    ...
                    <?php foreach ($data_user as $data) : ?>
                        <form action="<?= base_url("mastercontroller/update_data") ?>" method="POST">
                            ...
                            <div class="row row-space">
                                <div class="col-2">
                                    <div class="input-group">
                                        ...
                                        <input class="input--style-5" type="text" name="nama" value="<?php echo $data->nama ?>">
                                    </div>
                                </div>
                            </div>
                            <div class="row row-space">
                                <div class="col-2">
                                    <div class="input-group">
                                        ...
                                        <input class="input--style-4" type="text" name="umur" value="<?php echo $data->umur ?>">
                                    </div>
                                </div>
                                <div class="col-2">
                                    <div class="input-group">
                                        ...
                                        <div class="input-group-icon">
                                            <input class="input--style-4 js-datepicker" type="text" name="tanggal_lahir" value="<?php echo $data->tanggal_lahir ?>">
                            ...
                            <div class="row row-space">
                                <div class="col-2">
                                    <div class="input-group">
                                        ...
                                        <input class="input--style-5" type="text" name="alamat" value="<?php echo $data->alamat ?>">
                                    </div>
                                </div>
                            </div>
                            <div class="p-t-15">
                                <button class="btn btn--radius-2 btn--blue" type="submit">Submit</button>
                                <a href="<?= base_url('mastercontroller/dashboard') ?>" class="btn btn--radius-2 btn--black" type="button">Kembali</a>
                            </div>
                        </form>
                    <?php endforeach ?>
                </div>
